...
Wizard remains the next class to complete, followed by Warlock and Sorcerer.

## Merge note

This document reflects the Druid completion package and should be merged after the Druid package/status PR.

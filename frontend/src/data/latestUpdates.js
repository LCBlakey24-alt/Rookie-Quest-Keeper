export const LATEST_UPDATES = [
  {
    id: 'sunset-gradient-rebrand-2026-07-09',
    date: '2026-07-09',
    badge: 'Improved',
    category: 'Design & Polish',
    title: 'Sunset Gradient polish is being standardised',
    summary: 'The app is being aligned around a very dark blue-purple shell, deep indigo cards, white readable text, and purple-pink-orange gradient selected states.',
    details: [
      'Updated the shared visual direction so pages follow one consistent dark sunset-gradient identity.',
      'Converted legacy theme bridge files so older screens no longer pull the app back toward warm brown or gold-only styling.',
      'Tightened the rail, tabs, cards, auth screen, GM workspace, live play screen, homebrew, uploads, admin, and modal surfaces toward the same selected/unselected language.',
      'Added route-by-route visual QA guidance for mobile, tablet, and desktop checks.',
    ],
    public: true,
  },
  {
  ...
  },
  {
    ...
    summary: 'The long-term Rookie Quest Keeper direction is captured in repo docs covering responsive layouts, prototype testing, player goals, GM goals, and visual consistency.',
    details: [
      'Documented the move toward a consistent dark fantasy app shell with readable surfaces and clear action hierarchy.',
  ...
  },
  {
    ...
    badge: 'Improved',
    category: 'GM Screen',
    title: 'GM screen command centre polish',
    summary: 'The live GM screen now has a dedicated polish layer so the panel grid feels like a focused command centre.',
    details: [
      ...
      'Kept the existing 1–4 panel GM layout intact while making the screen feel closer to the current app theme.',
      'Improved the GM screen mobile/tablet behaviour so the page can scroll more naturally when panels stack.',
    ],
    public: true,
  },
  {
    id: 'dark-app-theme-pass-2026-06-24',
    date: '2026-06-24',
    badge: 'Improved',
    category: 'Design & Polish',
    title: 'Dark app theme pass expanded across the app',
    summary: 'The darker app direction has been pushed further through the dashboard, character sheet, and HP visuals.',
    details: [
      'Moved dashboard theme tokens toward deep dark surfaces, blue-purple panels, clear accent states, and readable text.',
      'Kept fantasy flavour focused on display headings so the app feels themed without hurting readability.',
      'Changed temporary HP back to a clearer bar with a thinner dark outline so it sits cleaner on the HP arc.',
  ...
  {
    id: 'dark-mobile-cleanup-2026-06-24',
    date: '2026-06-24',
    badge: 'New',
    category: 'Design & Mobile',
    title: 'Dark theme and mobile sheet clean-up',
    summary: 'The character sheet has started moving into a darker app style, with cleaner mobile layout and improved HP controls.',
    details: [
      'Added a darker colour direction using deep app surfaces, blue-purple panels, accent states, and readable text.',
      'Kept display typography decorative only where it helps, while keeping normal sheet text readable.',
  ...
  },
  {
    ...
    summary: 'The site has been cleaned up to better match Rookie Quest Keeper, with clearer typography and less cluttered update messaging.',
    details: [

...
describe('monk resource rules', () => {
  test('uses Monk class level for Ki/Focus resources', () => {
  ...
  test('renames Monk resource to Focus Points for 2024 rules', () => {
    expect(buildInitialClassResources({ character_class: 'Monk', level: 4, rules_edition: '2024' }).ki.label).toBe('Focus Points');
  });
});
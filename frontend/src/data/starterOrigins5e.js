...
export const STARTER_SPECIES = {
  ...
  'Beastfolk': {
    name: 'Beastfolk',
    description: 'Animal-like folk with sharp senses and a strong survival instinct.',
    speed: 30,
    size: 'Medium or Small',
    asi2014: { dexterity: 2, wisdom: 1 },
    asi2024: null,
    traits: [
      'Keen Senses',
      'Natural Movement',
      'Choose a cosmetic animal heritage with your GM',
    ],
  ...
  'Fey-Touched': {
    name: 'Fey-Touched',
    description: 'A hero shaped by strange bargains, forest magic, or the borderlands of the fey.',
    speed: 30,
    size: 'Medium',
    asi2014: { charisma: 2, wisdom: 1 },
    asi2024: null,
    traits: [
      'Fey Ancestry',
      'Glimmer of Glamour',
      'Work with your GM to flavour a minor fey trick',
    ],
  ...
  'Constructed': {
    name: 'Constructed',
    description: 'A built or awakened being with a body of crafted parts, runes, or living magic.',
    speed: 30,
    size: 'Medium',
    asi2014: { constitution: 2, intelligence: 1 },
    asi2024: null,
    traits: [
      'Built Body',
      'Sleepless Watch',
...
export const STARTER_BACKGROUNDS = {
  ...
  Healer: {
    name: 'Healer',
    description: 'A village medic, battlefield helper, herbalist, or travelling caretaker.',
    skillProficiencies: ['Medicine', 'Insight'],
    toolProficiencies: ['Herbalism kit'],
    equipment: ['Healer kit', 'Herbal pouch', 'Travel clothes', '10 gp'],
    feature: 'Trusted Caregiver',
  ...
  Performer: {
    name: 'Performer',
    description: 'A storyteller, dancer, musician, carnival worker, or travelling entertainer.',
    skillProficiencies: ['Performance', 'Persuasion'],
    toolProficiencies: ['Musical instrument', 'Disguise kit'],
    equipment: ['Instrument', 'Costume', 'Keepsake from an admirer', '15 gp'],
  ...
  Scholar: {
    name: 'Scholar',
    description: 'A researcher, tutor, scribe, librarian, or curious student of old knowledge.',
    skillProficiencies: ['Arcana', 'History'],
    toolProficiencies: ['Calligrapher tools'],
    equipment: ['Notebook', 'Ink pen', 'Reference notes', '10 gp'],
    feature: 'Research Contacts',
    asi2024: { intelligence: 2, wisdom: 1 },

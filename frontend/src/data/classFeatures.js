...
export const CLASS_FEATURES = {
  barbarian: {
    ...
    features: [
      ...
      { level: 3, name: 'Primal Path', type: 'passive', description: 'Choose a Primal Path. Built-in automation is limited to public-license subclass data.', isChoice: true },
  ...
  bard: {
    ...
    features: [
      ...
      { level: 3, name: 'Bard College', type: 'passive', description: 'Choose a Bard subclass. Built-in automation is limited to public-license subclass data.', isChoice: true },
    ...
    features_2024: [
      { level: 1, name: 'Bardic Inspiration', type: 'bonus_action', description: 'Give ally a Bardic Inspiration die (d6). Uses = CHA modifier, regain on long rest.', uses: 'CHA mod/long rest' },
  ...
  cleric: {
    ...
    features: [
      { level: 1, name: 'Divine Domain', type: 'passive', description: 'Choose a Cleric subclass. Built-in automation is limited to public-license subclass data.', isChoice: true },
    ...
    features_2024: [
      ...
      { level: 3, name: 'Cleric Subclass', type: 'passive', description: 'Choose a Cleric subclass. Built-in automation is limited to public-license subclass data.', isChoice: true },
  ...
  fighter: {
    ...
    features: [
      ...
      { level: 3, name: 'Martial Archetype', type: 'passive', description: 'Choose your Fighter subclass. Built-in automation is limited to public-license subclass data.', isChoice: true },

...
export const CLASS_COMPLETION_STATUS = [
  ...
  },
  {
    ...
    nextWork: 'Build Wizard Arcane Tradition/school summaries, spellbook/prepared-spell support, builder readiness, sheet summary, final status, package export, and tests.',
  },
  {
    className: 'Warlock',
    priority: 2,

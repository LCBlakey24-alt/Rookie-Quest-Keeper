...
export default function CleanCombatTab({ character, ac, speed, proficiencyBonus, onRoll, onCharacterUpdate, onDiceResult }) {
  ...
  return (
    <div className="clean-sheet-combat-wrap"><div className="clean-sheet-grid">
      ...
      <PaladinSummarySection character={character} resources={classResources} onLayOnHands={() => spendResourceAndPatch('lay_on_hands', {}, 'Lay on Hands')} onChannelDivinity={() => spendResourceAndPatch('channel_divinity', {}, 'Channel Divinity')} />

...
const inputStyle = { minHeight: 34, background: '#071A29', border: '1px solid rgba(214,168,79,0.18)', color: '#F7F1E7', padding: '0 8px', fontFamily: fontStack, fontWeight: 800, colorScheme: 'dark' };
const actionsStyle = { display: 'flex', gap: 5, flexWrap: 'wrap' };
const primaryButtonStyle = { minHeight: 34, border: '1px solid #D6A84F', background: '#112A40', color: '#F7F1E7', padding: '0 9px', fontWeight: 950, display: 'inline-flex', alignItems: 'center', gap: 5 };
const secondaryButtonStyle = { minHeight: 34, border: '1px solid rgba(214,168,79,0.18)', background: '#112A40', color: '#F7F1E7', padding: '0 9px', fontWeight: 850, display: 'inline-flex', alignItems: 'center', gap: 5 };
...
const textareaStyle = { width: '100%', boxSizing: 'border-box', background: '#071A29', border: '1px solid rgba(214,168,79,0.18)', color: '#F7F1E7', padding: 9, resize: 'vertical', fontFamily: fontStack, lineHeight: 1.4, outline: 'none', colorScheme: 'dark', fontSize: 12 };

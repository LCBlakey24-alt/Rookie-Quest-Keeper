...
const inputStyle = { minHeight: 34, background: '#081B2A', border: '1px solid rgba(255,45,170,0.18)', color: '#FFFFFF', padding: '0 8px', fontFamily: fontStack, fontWeight: 800, colorScheme: 'dark' };
const actionsStyle = { display: 'flex', gap: 5, flexWrap: 'wrap' };
const primaryButtonStyle = { minHeight: 34, border: '1px solid #FF2DAA', background: '#102B40', color: '#FFFFFF', padding: '0 9px', fontWeight: 950, display: 'inline-flex', alignItems: 'center', gap: 5 };
const secondaryButtonStyle = { minHeight: 34, border: '1px solid rgba(255,45,170,0.18)', background: '#102B40', color: '#FFFFFF', padding: '0 9px', fontWeight: 850, display: 'inline-flex', alignItems: 'center', gap: 5 };
...
const textareaStyle = { width: '100%', boxSizing: 'border-box', background: '#081B2A', border: '1px solid rgba(255,45,170,0.18)', color: '#FFFFFF', padding: 9, resize: 'vertical', fontFamily: fontStack, lineHeight: 1.4, outline: 'none', colorScheme: 'dark', fontSize: 12 };

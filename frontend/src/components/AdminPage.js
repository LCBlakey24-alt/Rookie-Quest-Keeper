...
import { Activity, ArrowLeft, BookOpen, Check, ClipboardList, FlaskConical, Hammer, LayoutDashboard, Map, MessageSquare, PenTool, RefreshCw, Search, Settings, Shield, Star, Trash2, UploadCloud, User, Users, Wand2, X } from 'lucide-react';
...
const adminTabIds = ['testing', 'character-audit', 'feedback', 'reviews', 'rules', 'templates', 'users', 'site'];
        ...
        <header style={heroStyle}>
          <div style={heroMainStyle}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <p style={adminSubtitleStyle}>Manage testing notes, feedback, reviews, users, rules, templates, and site switches without digging through Codex every time.</p>
            </div>
          </div>
          <div style={heroActionsStyle}>
            <Button onClick={fetchData} style={secondaryActionStyle}><RefreshCw size={16} />Refresh data</Button>
            <Button onClick={() => setActiveTab('site')} style={primaryActionStyle}><Settings size={16} />Site control</Button>
          </div>
        </header>

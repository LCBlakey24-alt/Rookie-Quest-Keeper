...
const titleStyle = { fontFamily: "var(--rq-font-display, 'Fraunces', 'RQKDisplay', serif)", fontSize: '1.55rem', color: 'var(--rq-text-primary, #F5E6C8)', margin: '0 0 6px 0', fontWeight: 900 };

...
const logoWrapStyle = { display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '12px 0 20px', cursor: 'pointer', flexShrink: 0 };
const logoStyle = { width: 'min(260px, 76vw)', height: 'auto', filter: 'drop-shadow(0 2px 10px rgba(192,138,61,0.45))' };
...
const titleStyle = { fontFamily: "var(--rq-font-display, 'Recoleta', 'RQKDisplay', serif)", fontSize: '1.55rem', color: 'var(--rq-text-primary, #F5E6C8)', margin: '0 0 6px 0', fontWeight: 900 };
